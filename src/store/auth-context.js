...
export const AuthContextProvider = (props) => {
  ...
  const [clienteUltimaCompra, setClienteUltimaCompra] = useState(initialClienteUltimaCompra)
  const [clienteMetaVenda, setClienteMetaVenda] = useState(initialClienteMetaVenda)
