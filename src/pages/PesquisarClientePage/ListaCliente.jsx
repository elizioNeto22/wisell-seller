...
const ListaCliente = ({ entidade, termo, onSelectCliente }) => {
  ...
  if (!data) return <p style={{ color: 'red' }}>nenhum cliente encontrado ...</p>
      ...
      <table style={{ color: 'black' }}>
        ...
        <tbody>
          {data?.fornecedores?.map((item) => {
            return (
              <tr key={item.id}>
                <ClienteItem id={item.id} item={item} onSelectCliente={onSelectCliente} />
              </tr>
            )
          })}
        </tbody>
