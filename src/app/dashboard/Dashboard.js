        ...
        <div className="row proBanner">
          <div className="col-12">
            <span className="d-flex align-items-center purchase-popup">
              <p>Bem-vindo, {this.props.userEmail}</p>
              <a href="/" className="btn purchase-button ml-auto">
                Verificar Agenda
              </a>
              <i
        ...
        <div className="row page-title-header">
          <div className="col-12">
            <div className="page-header">
              <h4 className="page-title">Painel de Controle</h4>
            </div>
          </div>
        </div>
        <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-12 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body pb-0">
                    <div className="d-flex justify-content-between">
                      <h4 className="card-title mb-0">Pedidos de Vendas</h4>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title mb-0">Vendas Mensais</h4>
                    <div className="d-flex align-items-center justify-content-between w-100">
                      <p className="mb-0">
                        pedidos de venda registrados nos últimos 12 meses
                      </p>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex justify-content-between">
                      <h4 className="card-title mb-0">Notas Fiscais</h4>
                      <a href="!#" onClick={(evt) => evt.preventDefault()}>
                        <small>Mostrar todas</small>
                      </a>
                    </div>
                    <p>
          ...
          <div className="col-md-4">
            <div className="row">
                      ...
                      <div className="col-xl-5 col-lg-12">
                        <div className="wrapper border-bottom mb-2 pb-2">
                          ...
                          <div className="d-flex align-items-center">
                            <p className="mb-0">Unidades vendidas</p>
                        ...
                        <div className="wrapper mb-2 mb-lg-0">
                          ...
                          <div className="d-flex align-items-center">
                            <p className="mb-0">Faturamento Total</p>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title mb-0">Ranking clientes</h4>
